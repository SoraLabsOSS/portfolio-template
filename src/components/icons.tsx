...
export function GitHubIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path
        d="M12 2C6.477 2 2 6.477 2 12C2 16.418 4.865 20.166 8.839 21.489C9.339 21.581 9.521 21.276 9.521 21.013C9.521 20.776 9.513 20.146 9.508 19.322C6.726 19.925 6.139 17.987 6.139 17.987C5.685 16.833 5.028 16.526 5.028 16.526C4.121 15.906 5.098 15.919 5.098 15.919C6.101 15.989 6.629 16.949 6.629 16.949C7.521 18.479 8.97 18.037 9.54 17.781C9.63 17.137 9.889 16.697 10.175 16.447C7.955 16.194 5.62 15.337 5.62 11.58C5.62 10.51 6.01 9.633 6.649 8.946C6.546 8.69 6.203 7.686 6.747 6.337C6.747 6.337 7.586 6.064 9.496 7.352C10.295 7.13 11.15 7.019 12 7.015C12.85 7.019 13.705 7.13 14.505 7.352C16.414 6.064 17.252 6.337 17.252 6.337C17.797 7.686 17.454 8.69 17.351 8.946C17.991 9.633 18.378 10.51 18.378 11.58C18.378 15.347 16.039 16.191 13.813 16.439C14.172 16.748 14.492 17.357 14.492 18.289C14.492 19.625 14.48 20.685 14.48 21.013C14.48 21.279 14.66 21.587 15.167 21.487C19.138 20.163 22 16.416 22 12C22 6.477 17.523 2 12 2Z"
        fill="currentColor"
      />
    </svg>
  );
