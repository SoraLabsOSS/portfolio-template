...
export function Bunny({ className, size = 32, sleeping = false }: BunnyProps) {
  ...
  return (
    ...
    >
        ...
        {sleeping ? (
          <>
            <g transform="rotate(-15, 7, 10) translate(0, 1)">
              <path
                className={canAnimate ? "bunny-ear-left-sleep" : undefined}
                d={EAR_LEFT_PATH}
                fill="currentColor"
              />
            </g>
            <g transform="rotate(15, 19, 10) translate(0, 1)">
              <path
                className={canAnimate ? "bunny-ear-right-sleep" : undefined}
                d={EAR_RIGHT_PATH}
                fill="currentColor"
              />
            </g>
          ...
          <>
            <path
              className={canAnimate ? "bunny-ear-left-awake" : undefined}
              d={EAR_LEFT_PATH}
              fill="currentColor"
            />
            <path
              className={canAnimate ? "bunny-ear-right-awake" : undefined}
              d={EAR_RIGHT_PATH}
              fill="currentColor"
            />
          </>
        )}
        <path d={FACE_PATH} fill="currentColor" />
        {sleeping ? (
          <>
            <rect
              fill="currentColor"
          ...
          <>
            <motion.rect
              animate={
                canAnimate
                  ? LEFT_EYE_ANIMATE
                  : { scaleY: 1, x: 6.477, y: 18.666 }
              }
              fill="currentColor"
              height="3.6"
              initial={{ scaleY: 1, x: 6.477, y: 18.666 }}
              rx="1.8"
              style={EYE_STYLE}
              transition={canAnimate ? EYE_TRANSITION : undefined}
              width="3.6"
            />
            <motion.rect
              animate={
                canAnimate
                  ? RIGHT_EYE_ANIMATE
                  : { scaleY: 1, x: 18.078, y: 18.666 }
              }
              fill="currentColor"
              height="3.6"
              initial={{ scaleY: 1, x: 18.078, y: 18.666 }}
              rx="1.8"
              style={EYE_STYLE}
              transition={canAnimate ? EYE_TRANSITION : undefined}
              width="3.6"
      ...
      {sleeping && canAnimate ? (
        ...
        >
          <g className="bunny-z bunny-z-1" strokeWidth="1.5">
            <path d="M32 5 L36 5 L32 9 L36 9" />
          </g>
          <g className="bunny-z bunny-z-2" strokeWidth="1.3">
            <path d="M34 3 L37 3 L34 6 L37 6" />
          </g>
          <g className="bunny-z bunny-z-3" strokeWidth="1.1">
